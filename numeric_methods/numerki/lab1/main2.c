...
double In(double Iprev, double dt);
...
double In(double Iprev, double dt, double k1, double k2, double k3, double k4)
{
    Iprev + dt*(k1+k2+k3+k4)/6.0;
}

double Qn(double Qprev, double dt, double k1, double k2, double k3, double k4)
{
    Qprev + dt*(k1+k2+k3+k4)/6.0;
}
            ...
            double Q0, double L, double C, double R, double aw)
{
    ...
    while(curr_t <= tlast)
    {
        ...
        I0 = In(I0, k1, k2, k3, k4);
        Q0 = Qn(Q0, k1, k2, k3, k4);
